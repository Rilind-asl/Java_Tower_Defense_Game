...
public class ZilyanaTowerMoving extends Effects 
{
	// Private image variable
	private BufferedImage image;
	
	//Constructor
	public ZilyanaTowerMoving(GameState game, Point position) 
	{
		// calling super class
		super(game,position);
	...
	public void update() 
	{
		...
		if(game.getMousePressed() && game.credits >= 10 && game.getMousePos().x < 600)
		{
			...
			game.pendingAnimatable(new ZilyanaTower(game, position));
